-- Vimspector
-- vim.api.nvim_create_autocmd("VimEnter", { command = "silent! VimspectorLoadSession .vim/" })
-- vim.api.nvim_create_autocmd("VimLeave", { command = "silent! VimspectorMkSession .vim/" })
vim.cmd([[
