	...
	config = function()
		...
		conform.setup({
			...
			formatters_by_ft = {
				...
				tex = { "latexindent", "typos", lsp_format = "fallback" },
				...
				markdown = { "prettierd", "typos", lsp_format = "fallback" },
				...
				scss = { "prettierd", "prettier", stop_after_first = true, lsp_format = "fallback" },
